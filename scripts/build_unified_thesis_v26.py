"""
Build the unified PhD thesis v26 — self-reference removed, references renumbered.

vs v24:
  v24: References had [2] D.-W. Shin (this dissertation) — non-standard
       self-reference; entries [1]–[101].
  v26: [2] removed, [3]–[101] renumbered to [2]–[100]. Body inline citations
...
vs v24/v23/v22 누적 정정 (모두 v26 에 포함):
...
Usage:
    python scripts/build_unified_thesis_v26.py
"""
...
V20 = V5 / "v20"
OUT_MD = V5 / "통합본_v26.md"
OUT_DOCX = V5 / "박사논문_통합본_v26.docx"
